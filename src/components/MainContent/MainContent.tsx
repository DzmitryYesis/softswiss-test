    ...
    return (
        <div className={'main-content'}>
            <div className={'offers'}>
                <span className={'offers__text'}>Offers</span>
